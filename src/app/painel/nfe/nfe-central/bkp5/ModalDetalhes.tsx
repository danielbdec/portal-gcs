...
export default function ModalDetalhes({ chave, statusNF, visivel, onClose, nomeFornecedor, onActionSuccess, status_tes, statusCompras, observacao }: ModalDetalhesProps) {
  ...
  const [isFinanceiroModalOpen, setIsFinanceiroModalOpen] = useState(false); // Estado para o novo modal
                    ...
                    {activeTab === 'financeiro' && (
                        <div>
                            ...
                            <div style={{
                                ...
                                <p style={{ margin: 0, lineHeight: 1.6 }}>
                                    Consulte os boletos registrados no DDA (Débito Direto Autorizado) nos últimos 90 dias emitido pelo fornecedor.
                                </p>
                                <div style={{ marginTop: '1.5rem' }}>
                                    <button
