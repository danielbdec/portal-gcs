                        ...
                        <div>
                            <div style={{
                                ...
                                <p style={{ margin: '0 0 1.5rem 0', lineHeight: 1.6, fontSize: '14px', color: '#333' }}>
                                    Consulte os boletos registrados no DDA (Débito Direto Autorizado) ou os títulos financeiros gerados para esta nota fiscal diretamente no Protheus.
                                </p>
