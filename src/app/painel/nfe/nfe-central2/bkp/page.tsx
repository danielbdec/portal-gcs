...
export default function ConsultaNotas() {
  ...
  return (<>
    ...
    <style>{`
        ...
        /* Cores fortes KPI */
        body.dark .kpi-value-green { color: #7CFF70 !important; }
        body.dark .kpi-value-orange { color: #FFA24A !important; }
        
        body.dark .loading-text { color: #93C5FD; }
        body.dark .ant-pagination-total-text { color: #CBD5E1 !important; }
        body.dark .time-ago-text { color: #94A3B8 !important; }
        body.dark .filter-applied-text { color: #FCA5A5 !important; }
        ...
        body.dark .filter-popover-content {
            background: rgba(25, 39, 53, 0.7) !important;
            backdrop-filter: blur(16px) !important;
            -webkit-backdrop-filter: blur(16px) !important;
            border: 1px solid rgba(125, 173, 222, 0.2) !important;
        }
        ...
        /* === CORREÇÃO: Estilos do PriorityRibbonTabs (Ponto 3) === */
