...
export default function ConsultaNotas() {
  ...
  return (<>
    ...
    <style>{`
        ...
        body.dark .p1 .seg-item:hover:not([aria-pressed="true"]) { /* Adicionado :not */
        ...
        body.dark .p2 .seg-item:hover:not([aria-pressed="true"]) { /* Adicionado :not */
        ...
        body.dark .p3 .seg-item:hover:not([aria-pressed="true"]) { /* Adicionado :not */
