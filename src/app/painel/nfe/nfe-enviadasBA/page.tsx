...
export default function ConsultaNotas() {
  ...
  // CORREÇÃO AQUI: Mudando de null para undefined para agradar o Recharts
  ...
  useEffect(() => {
    if (filtroStatus === 'Todos') {
        setActiveIndex(undefined); // CORREÇÃO: undefined
    } else {
        const newActiveIndex = dadosGraficoStatus.findIndex(
            (data) => data.name === filtroStatus
        );
        setActiveIndex(newActiveIndex !== -1 ? newActiveIndex : undefined); // CORREÇÃO: undefined
    }
