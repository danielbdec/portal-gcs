...
export default function StatusOverview() {
  ...
  useEffect(() => {
      if (!loading) {
        const timer = setTimeout(() => {
            ...
            setLoadingFilter(null); // <-- DESLIGA O SPINNER DO BOTÃO
        }, 100);
  ...
  const filterStyle: React.CSSProperties = { 
    ...
    minHeight: '28px', // Garante altura mínima
    display: 'inline-flex',
    alignItems: 'center',
        ...
        {loading ? <LoadingSpinner text="Carregando dados do dashboard..." /> : (
          <>
            ...
            <div className="chart-grid-two-column">
                ...
                extra={(
                  <div>
                    <button 
                      ...
                      onClick={() => {
                        setLoadingFilter('geral'); // <-- LIGA SPINNER
                        setRankingFilter('geral');
                      }}
                      disabled={loadingFilter !== null} // <-- DESABILITA
                    >
                    ...
                    <button 
                      ...
                      onClick={() => {
                        setLoadingFilter('mes'); // <-- LIGA SPINNER
                    ...
                    <button 
                      ...
                      onClick={() => {
                        setLoadingFilter('semana'); // <-- LIGA SPINNER
              ...
              >
                {/* --- LÓGICA DO SPINNER REMOVIDA DAQUI --- */}
