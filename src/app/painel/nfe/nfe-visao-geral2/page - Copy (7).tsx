...
export default function StatusOverview() {
  ...
  const kpiOrangeColor = theme === 'light' ? '#F58220' : '#FF9A3C';

  // --- MUDANÇA: Estilos dos botões de filtro atualizados ---
  ...
  const filterStyle: React.CSSProperties = theme === 'light' ? {
    ...
    ...baseFilterStyle,
    background: 'rgba(25, 39, 53, 0.25)', // Fundo de vidro
    border: '1px solid rgba(125, 173, 222, 0.2)', // Borda de vidro
  ...
  return (
    <div className="dashboard-container" style={{ padding: "2rem", maxWidth: "1200px", margin: "0 auto" }}>
      ...
      <svg width="0" height="0" style={{ position: 'absolute', zIndex: -1 }}>
        <defs>
          ...
          <linearGradient id="gradPrata" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#F0F0F0" /> {/* Cinza Claro (Brilho) */}
            <stop offset="100%" stopColor="#B0B0B0" /> {/* Cinza Médio (Corpo) */}
          </linearGradient>
        ...
        {loading ? <LoadingSpinner text="Carregando dados do dashboard..." /> : (
          <>
            ...
            <div className="chart-grid-two-column">
              ...
              {/* GRÁFICO RANKING DE ENVIO (COM FILTRO E SPINNER NO BOTÃO) */}
              <Card 
      ...
      <style jsx global>{`
        ...
        body.light { background-image: none !important; animation: none !important; }
        ...
        body.dark .kpi-card h3 { margin: 0 0 0.5rem 0; color: #E2E8F0; text-align: center; font-size: 0.9rem; font-weight: 500; }
        body.dark .kpi-card h2 { margin: 0; font-size: 2rem; color: #F1F5F9; text-align: center; } 
        /* MUDANÇA AQUI: Título da página com mais contraste */
        ...
        body.dark .recharts-legend-item text[color="#00314A"] { color: #E2E8F0 !important; }
        ...
        /* MUDANÇA AQUI: Cor da borda do botão de tema */
